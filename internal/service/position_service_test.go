...
func TestPositionService_GetByIDWithDepartment_Success(t *testing.T) {
	mock := NewMockPositionRepo()
	svc := NewPositionService(mock)
	ctx := context.Background()
	...
	result, err := svc.GetByIDWithDepartment(ctx, created.ID)
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
	if result.Name != "Gerente" {
...
func TestPositionService_GetByIDWithDepartment_NotFound(t *testing.T) {
	mock := NewMockPositionRepo()
	svc := NewPositionService(mock)
	ctx := context.Background()

	_, err := svc.GetByIDWithDepartment(ctx, 999)
	if !errors.Is(err, domain.ErrPositionNotFound) {
		t.Fatalf("expected ErrPositionNotFound, got %v", err)
	}
}

func TestPositionService_GetByIDWithDepartment_InvalidID(t *testing.T) {
	mock := NewMockPositionRepo()
	svc := NewPositionService(mock)
	ctx := context.Background()

	_, err := svc.GetByIDWithDepartment(ctx, 0)
	if err == nil {
		t.Fatal("expected error for invalid id")
	}
}

func TestPositionService_ListByDepartment_Success(t *testing.T) {
	mock := NewMockPositionRepo()
	svc := NewPositionService(mock)
	ctx := context.Background()
...
func TestPositionService_ListByDepartment_InvalidID(t *testing.T) {
	mock := NewMockPositionRepo()
	svc := NewPositionService(mock)
	ctx := context.Background()
...
func TestPositionService_CountByDepartment_Success(t *testing.T) {
	mock := NewMockPositionRepo()
	svc := NewPositionService(mock)
	ctx := context.Background()
	...
	total, err := svc.CountByDepartment(ctx, 1)
	if err != nil {
		t.Fatalf("expected no error, got %v", err)
	}
	if total != 3 {
...
func TestPositionService_CountByDepartment_InvalidID(t *testing.T) {
	mock := NewMockPositionRepo()
	svc := NewPositionService(mock)
	ctx := context.Background()

	_, err := svc.CountByDepartment(ctx, 0)
	if err == nil {
		t.Fatal("expected error for invalid department id")
	}
}
